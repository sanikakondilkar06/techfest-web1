...
// Note: Locomotive Scroll is commented out as it was in the original code.
// Uncomment if you are using it in your project.
// const scroll = new LocomotiveScroll({
//     el: document.querySelector('[data-scroll-container]'),
//     smooth: true
// });

// --- SPLASH SCREEN & INITIAL ANIMATIONS ---
...
// --- MAIN CONTENT ANIMATION FUNCTION ---
function animateMainContent() {
    // 1. Animate the letters of the "IETE KJSIT" title
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  prevBtn.addEventListener("click", () => {
    currentIndex = (currentIndex - 1 + timelinePoints.length) % timelinePoints.length;
    showSlide(currentIndex);
  });
